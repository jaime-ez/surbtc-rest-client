...
function errorSet (response, body) {
  ...
  if (body.status === StatusCode.notAcceptable) {
    notAcceptableError(response, body.error, null)
  }
...
/**
 * Send a unacceptable error response
 *
 * @param response  - response object
 * @param message   - (optional) additional error message
 * @param body      - (optional) additional body to the response
 */
function notAcceptableError (response, message, body) {
  var content = {
    success: false,
    error_type: ErrorType.notAcceptable
  }
  ...
  send(response, content, StatusCode.notAcceptable)
}
...
function send (response, body, statusCode) {
  ...
  response.json = body
  response.json.statusCode = statusCode
}
